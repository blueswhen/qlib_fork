...
VALIDATION_RESULTS_PATH = BASE_DIR / "alpha360_tra_fundamental_dnn_weight_refine_validation_results.csv"
VALIDATION_BEST_PATH = BASE_DIR / "alpha360_tra_fundamental_dnn_weight_refine_validation_best.txt"
FINAL_TEST_PATH = BASE_DIR / "alpha360_tra_fundamental_dnn_weight_refine_final_test.txt"
...
SELECTED_TRIAL = {
    "trial_name": "dnn03_techA3d_fund_rankpct_wide_s240",
...
DNN_VALID_STAGE_SUFFIX = "tra_fund_rankpct_fusion_valid"
DNN_TEST_STAGE_SUFFIX = "tra_fund_rankpct_fusion_test"
...
def main():
    ...
    for tab_weight in TAB_WEIGHTS:
        ...
        try:
            ...
            metrics = _evaluate_signal(
                ...
                experiment_name="alpha360_tra_fundamental_dnn_weight_refine_validation_eval",
            )
            row.update(
                {
                    "status": "success",
    ...
    test_metrics = _evaluate_signal(
        ...
        experiment_name="alpha360_tra_fundamental_dnn_weight_refine_final_test_eval",
    )
    test_metrics.update(
        {
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Local weight refine for Alpha360(TRA) + fundamental DNN fusion.")
    parser.parse_args()
    main()
