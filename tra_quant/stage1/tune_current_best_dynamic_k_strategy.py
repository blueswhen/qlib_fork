...
VALIDATION_RESULTS_PATH = BASE_DIR / "alpha360_tra_fundamental_xgb_dynamic_k_strategy_validation_results.csv"
VALIDATION_BEST_PATH = BASE_DIR / "alpha360_tra_fundamental_xgb_dynamic_k_strategy_validation_best.txt"
FINAL_TEST_PATH = BASE_DIR / "alpha360_tra_fundamental_xgb_dynamic_k_strategy_final_test.txt"
...
def _build_trials(manifest: dict) -> list[dict]:
    ...
    return [
        ...
        {
            "trial_name": "dynk_l095_h120",
            "strategy_class": "AdaptiveTopkPracticalTopkDropoutStrategy",
            ...
            "kwargs_extra": {
                ...
                "mid_topk": 5,
                "high_topk": 3,
                "low_spread_thresh": 0.95,
                "high_spread_thresh": 1.20,
            },
        },
        {
            "trial_name": "dynk_l100_h125",
            "strategy_class": "AdaptiveTopkPracticalTopkDropoutStrategy",
            "strategy_module_path": "qlib.contrib.strategy.custom_signal_strategy",
            "n_drop": common_kwargs["n_drop"],
            "risk_degree": common_kwargs["risk_degree"],
            "kwargs_extra": {
                ...
                "mid_topk": 5,
                "high_topk": 3,
                "low_spread_thresh": 1.00,
                "high_spread_thresh": 1.25,
            },
        },
        {
            "trial_name": "dynk_l108_h133",
            "strategy_class": "AdaptiveTopkPracticalTopkDropoutStrategy",
            "strategy_module_path": "qlib.contrib.strategy.custom_signal_strategy",
            "n_drop": common_kwargs["n_drop"],
            "risk_degree": common_kwargs["risk_degree"],
            "kwargs_extra": {
                ...
                "mid_topk": 5,
                "high_topk": 3,
                "low_spread_thresh": 1.08,
                "high_spread_thresh": 1.33,
            },
        },
        {
            "trial_name": "dynk_l090_h115",
            "strategy_class": "AdaptiveTopkPracticalTopkDropoutStrategy",
            "strategy_module_path": "qlib.contrib.strategy.custom_signal_strategy",
            "n_drop": common_kwargs["n_drop"],
            "risk_degree": common_kwargs["risk_degree"],
            "kwargs_extra": {
                ...
                "mid_topk": 5,
                "high_topk": 3,
                "low_spread_thresh": 0.90,
                "high_spread_thresh": 1.15,
            },
        },
    ]
...
def _evaluate_trial(manifest: dict, trial: dict, pred: pd.DataFrame, label: pd.DataFrame, eval_segment: str) -> dict:
    ...
    recorder_name = f"current_best_dynamic_k_{eval_segment}_{trial['trial_name']}"
    with R.start(experiment_name=f"current_best_dynamic_k_{eval_segment}_eval", recorder_name=recorder_name):
        rec = R.get_recorder()
...
def main():
    ...
    if not success_rows:
        raise RuntimeError("no successful validation rows for dynamic-k strategy experiment")
