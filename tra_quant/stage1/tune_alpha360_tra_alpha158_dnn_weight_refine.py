...
CURRENT_BEST_FINAL_PATH = BASE_DIR / "alpha360_alpha158_dnn_weight_refine_final_test.txt"

VALIDATION_RESULTS_PATH = BASE_DIR / "alpha360_tra_alpha158_dnn_weight_refine_validation_results.csv"
VALIDATION_BEST_PATH = BASE_DIR / "alpha360_tra_alpha158_dnn_weight_refine_validation_best.txt"
FINAL_TEST_PATH = BASE_DIR / "alpha360_tra_alpha158_dnn_weight_refine_final_test.txt"
...
FUSION_MODE = "zscore"
TAB_WEIGHTS = [0.08, 0.10, 0.12, 0.15, 0.18, 0.20]
DNN_VALID_STAGE_SUFFIX = "tra_fusion_valid"
DNN_TEST_STAGE_SUFFIX = "tra_fusion_test"
...
def main():
    ...
    for tab_weight in TAB_WEIGHTS:
        ...
        try:
            ...
            metrics = _evaluate_signal(
                ...
                experiment_name="alpha360_tra_alpha158_dnn_weight_refine_validation_eval",
            )
            row.update(
                {
                    "status": "success",
    ...
    test_metrics = _evaluate_signal(
        ...
        experiment_name="alpha360_tra_alpha158_dnn_weight_refine_final_test_eval",
    )
    test_metrics.update(
        {
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Local weight refine for Alpha360(TRA) + Alpha158(DNN) fusion.")
    parser.parse_args()
    main()
